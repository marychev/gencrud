    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subitems', to='task.Task', verbose_name='Родительский объект')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Задача: фото',
                'verbose_name_plural': 'Задачи: фото',
                'abstract': False,
            },
        ),
    ]

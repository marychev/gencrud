...
SWTTINGSTEMPLATE_IS_INCLUDED_HT = """Включеной может быть только один шаблон"""
...
HTML_HT = '''
Старайтесь не использовать заголовок <.H1> в контенте. 
Так как заголово изначально формирует сама страница, 
и этот заголовок должен быть всего один!'''
